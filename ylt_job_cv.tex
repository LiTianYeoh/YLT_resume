...
\begin{minipage}[t]{\rhsWidth}
	...
	\vspace{6pt}
	\newline
	\textit{A data analyst with 2 years of experience, focusing on machine learning and predictive modelling. Skilled in data visualization and leveraging machine learning techniques to drive data-driven decision-making.}
	\vspace{12pt}	
	...
	\begin{expSection} {Beyondsoft Malaysia} {2024 May - Present} {Data Analyst Engineer (outsourced from Tencent Games)}
		\begin{itemize} [itemsep = 0pt, parsep=2pt]
			...
			\item Developed a macro (auto-click) detection model using game interaction log data, achieving an average detection rate of 5 players per day. The process involved analyzing game recordings, preprocessing log data, performing feature engineering, training and testing the model for accurate detection.
		\end{itemize}
	\end{expSection}
